...
<head>
  ...
  <title>미국 주식 옵션 한국어 가이드와 무료 강의 | Options America</title>
  <meta name="description" content="미국 주식 옵션을 한국어로 배우세요. 초보자 기초, 콜옵션·풋옵션, 커버드콜, 옵션 그릭스와 무료 강의를 네 개의 학습 과정으로 제공합니다.">
  <link rel="canonical" href="{BASE}/ko/blog/">
  <meta property="og:locale" content="ko_KR"><meta property="og:type" content="website"><meta property="og:title" content="미국 주식 옵션 한국어 가이드와 무료 강의"><meta property="og:description" content="옵션 기초부터 콜·풋, 커버드콜까지 순서대로 배우는 한국어 학습 허브입니다."><meta property="og:url" content="{BASE}/ko/blog/"><meta property="og:image" content="{BASE}/assets/images/courses/legacy/options-trading-course-level-1-buying-call-option.png">
...
<body>
  ...
  <main><section class="blog-hero ko-blog-hero"><div class="container"><p class="eyebrow">미국 주식 옵션 · 한국어 학습 허브</p><h1>미국 주식 옵션, 기초부터 전략까지 배우세요</h1><p>초보자 기초부터 콜옵션·풋옵션, 커버드콜, 옵션 그릭스까지. 스무 개의 심층 가이드를 네 개의 학습 과정으로 연결했습니다.</p><div class="ko-hero-actions"><a class="btn btn-gold" href="{COURSE}">Google로 무료 강의 시작</a><a class="btn ko-secondary" href="us-stock-options-guide/">종합 가이드 먼저 읽기</a></div></div></section>
  <section class="blog-main"><div class="container"><div class="section-heading"><div><p class="eyebrow blue">Cluster 1 · Beginner</p><h2>미국 주식 옵션 초보자 과정</h2><p>아래 순서대로 읽으면 개념에서 실제 주문 준비까지 자연스럽게 이어집니다.</p></div></div><div class="blog-grid ko-blog-grid">{cards}</div></div></section>
  <section class="blog-main ko-cluster-section"><div class="container"><div class="section-heading"><div><p class="eyebrow blue">다음 학습 과정</p><h2>주제별 심화 과정</h2><p>기초를 익혔다면 계약의 차이, 전략과 옵션 가격 위험을 집중적으로 학습하세요.</p></div></div><div class="ko-cluster-grid"><a class="ko-cluster-card" href="call-put-options/"><img src="/assets/images/blog/call-delta-vs-put-delta.webp" alt="콜옵션과 풋옵션 차이"><div><span>Cluster 2 · 5개 가이드</span><h2>콜옵션과 풋옵션</h2><p>콜·풋의 뜻, 권리와 의무, 손익, ITM·ATM·OTM과 계약 선택을 배웁니다.</p><strong>과정 시작 →</strong></div></a><a class="ko-cluster-card" href="covered-call/"><img src="/assets/images/blog/covered-call-income-potential.webp" alt="커버드콜 전략"><div><span>Cluster 3 · 5개 가이드</span><h2>커버드콜 전략</h2><p>전략 구조, 수익과 손실, 행사가·만기, 배정·배당과 위험관리를 배웁니다.</p><strong>과정 시작 →</strong></div></a><a class="ko-cluster-card" href="option-greeks/"><img src="/assets/images/blog/option-greeks-explained.webp" alt="옵션 그릭스 델타 세타 베가 감마"><div><span>Cluster 4 · 5개 가이드</span><h2>옵션 그릭스</h2><p>델타, 세타, 베가와 감마가 옵션 가격과 포지션 위험을 어떻게 바꾸는지 배웁니다.</p><strong>과정 시작 →</strong></div></a></div></div></section></main>

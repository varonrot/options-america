...
<head>
  ...
  <meta name="description" content="미국 주식 옵션을 한국어로 배우세요. 초보자 기초, 콜옵션·풋옵션, 커버드콜 전략과 무료 강의를 세 개의 학습 과정으로 제공합니다.">
...
<body>
  ...
  <main><section class="blog-hero ko-blog-hero"><div class="container"><p class="eyebrow">미국 주식 옵션 · 한국어 학습 허브</p><h1>미국 주식 옵션, 기초부터 전략까지 배우세요</h1><p>초보자 기초부터 콜옵션·풋옵션의 손익 구조, 커버드콜 운용까지. 열다섯 개의 심층 가이드를 세 개의 학습 과정으로 연결했습니다.</p><div class="ko-hero-actions"><a class="btn btn-gold" href="{COURSE}">Google로 무료 강의 시작</a><a class="btn ko-secondary" href="us-stock-options-guide/">종합 가이드 먼저 읽기</a></div></div></section>

...
PAGES = {
    "privacy-policy": {
        ...
        "sections": [
            ("Information we collect", "<p>We may collect technical and usage information automatically, including your browser and device type, approximate location derived from your IP address, referring page, pages viewed, clicks, and the date and time of your visit.</p><p>If you choose to sign in with Google, we receive basic account information made available through the sign-in service, such as your name, email address, profile image, account identifier, and session information. If you voluntarily submit information through a form or email, we also receive the information you choose to provide. Please do not send sensitive personal or financial information through the Site.</p>"),
            ...
            ("Sharing and sale of information", "<p>We may share information with service providers that help us host, authenticate users, measure, secure, or operate the Site, including Supabase and Google, and when required by law or necessary to protect rights and safety. We do not sell personal information for money. These providers may process data according to their own policies.</p>"),

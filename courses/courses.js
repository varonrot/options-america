const courses = [
  ...
  {title:'Options Trading Course Level 6: Vega and Volatility',level:'Beginner',categories:['Basic Option','Option Greeks'],url:'/courses/options-trading-course-level-6-vega-and-volatility/',image:'../assets/images/courses/greek-option-level-6-vega-volatility-trading.webp'},
  ...
  {title:'Options Strategies Level 22: VIX Hedging And Speculation',level:'Intermediate',categories:['Advanced Options'],url:'/courses/level-22-vix-options-hedging-and-speculation/',image:'../assets/images/courses/legacy/level-22-vix-options-hedging-and-speculation.png'},
  ...
  {title:'Options Strategies Level 49: Event-Driven Catalyst',level:'Advanced',categories:['Options Strategies'],url:'/courses/level-49-event-driven-catalyst-strategy/',image:'../assets/images/courses/legacy/level-49-event-driven-catalyst-strategy.png'},
  {title:'Adjustments Short Iron Condor Strategies',level:'Intermediate',categories:['Options Adjustments'],url:'/courses/adjustments-short-iron-condor-strategies/',image:'../assets/images/courses/legacy/adjustments-short-iron-condor-strategies.png'},
  {title:'Case Studies – Butterfly Strategies',level:'Intermediate',categories:['Case Studies'],url:'/courses/case-studies-butterfly-strategiesgle-3/',image:'../assets/images/courses/legacy/case-studies-butterfly-strategiesgle-3.png'},
  {title:'Case Studies – Short Strangle',level:'Intermediate',categories:['Case Studies'],url:'/courses/case-studies-short-strangle-3/',image:'../assets/images/courses/legacy/case-studies-short-strangle-3.png'},
  ...
  {title:'Adjustments Calendar Spreads',level:'Intermediate',categories:['Options Adjustments'],url:'/courses/adjustments-calendar-spreads-2/',image:'../assets/images/courses/legacy/adjustments-calendar-spreads-2.png'},
  {title:'Adjustments – Short Straddle',level:'Intermediate',categories:['Options Adjustments'],url:'/courses/adjustments-short-straddle-2/',image:'../assets/images/courses/legacy/adjustments-short-straddle-2.png'},
  {title:'Case Studies – Short Straddle',level:'Intermediate',categories:['Case Studies'],url:'/courses/case-studies-short-straddle-2/',image:'../assets/images/courses/legacy/case-studies-short-straddle-2.png'},
  ...
  {title:'Managing a Bullish to Neutral Options Portfolio',level:'Advanced',categories:['Options Portfolio'],url:'/courses/managing-a-bullish-to-neutral-options-portfolio/',image:'../assets/images/courses/legacy/managing-a-bullish-to-neutral-options-portfolio.png'},
  {title:'Introduction to Futures Contract',level:'Advanced',categories:['Options on Futures'],url:'/courses/introduction-to-futures-contract/',image:'../assets/images/courses/legacy/introduction-to-futures-contract.png'},
  {title:'Level 72 – Natural Gas Options on Futures',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-72-natural-gas-options-on-futures-2/',image:'../assets/images/courses/legacy/level-72-natural-gas-options-on-futures-2.png'},
  {title:'Level 73 – Crude Oil Options on Futures',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-73-crude-oil-options-on-futures/',image:'../assets/images/courses/legacy/level-73-crude-oil-options-on-futures.png'},
  {title:'Level 77 – Silver Trading Options on Future',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-77-silver-trading-options-on-future/',image:'../assets/images/courses/legacy/level-77-silver-trading-options-on-future.png'},
  {title:'Level 81 – Gold Trading Options on Future',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-81-gold-trading-options-on-future/',image:'../assets/images/courses/legacy/level-81-gold-trading-options-on-future.png'},
  {title:'Level 82 – Corn Futures Trading Strategy',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-82-corn-futures-trading-strategy/',image:'../assets/images/courses/legacy/level-82-corn-futures-trading-strategy.png'},
  {title:'Level 83 – Soybean Trading Future Professionals',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-83-soybean-trading-future-professionals/',image:'../assets/images/courses/legacy/level-83-soybean-trading-future-professionals.png'},
  {title:'Level 84 – Wheat Trading Future Professionals',level:'Advanced',categories:['Options on Futures'],url:'/courses/level-84-wheat-trading-future-professionals/',image:'../assets/images/courses/legacy/level-84-wheat-trading-future-professionals.png'},
  {title:'Level 85 – UVXY Stock Strategies',level:'Advanced',categories:['Options Strategies'],url:'/courses/level-85-uvxy-stock-strategies/',image:'../assets/images/courses/legacy/level-85-uvxy-stock-strategies.png'},
  {title:'Building a Diversified Portfolio',level:'Intermediate',categories:['Options Portfolio'],url:'/courses/building-a-diversified-portfolio/',image:'../assets/images/courses/legacy/building-a-diversified-portfolio.png'},
  ...
  {title:'Practical Usage – Level 1.1 – Long Call',level:'Beginner',categories:['Basic Option','Beginner Case Studies','Options for Beginner'],url:'/courses/practical-usage-level-1-1-long-call/',image:'../assets/images/courses/legacy/practical-usage-level-1-1-long-call.png'},

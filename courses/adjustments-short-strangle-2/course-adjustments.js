const DURATION_CACHE_KEY='oa-adjustments-short-strangle-vimeo-durations';
const curriculumGroups=[
{title:"Module 1: Course Overview and Position Analysis",lessons:[1,2,3]},
{title:"Module 2: Rolling and Rebalancing",lessons:[4,5]},
{title:"Module 3: Adding Protective Structures",lessons:[6,7]},
{title:"Module 4: Strategy Conversions",lessons:[8,9]},
{title:"Module 5: Course Summary",lessons:[10]}
];

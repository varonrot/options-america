const DURATION_CACHE_KEY='oa-adjusting-covered-call-vimeo-durations';
const curriculumGroups=[
  {title:'Module 1: Covered Call Adjustment Foundations',lessons:[1,2,3,4]},
  {title:'Module 2: Rolling and Protecting the Position',lessons:[5,6,7,8]},
  {title:'Module 3: Strategy Conversions',lessons:[9,10,11]},
  {title:'Module 4: Portfolio Risk Management',lessons:[12,13,14,15]},
  {title:'Module 5: Summary',lessons:[16]}
];

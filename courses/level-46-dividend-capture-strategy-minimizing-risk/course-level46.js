const DURATION_CACHE_KEY='oa-level46-vimeo-durations';
const curriculumGroups=[
{title:"Module 1: Dividend Foundations",lessons:[1,2,3,4,5,6,7,8]},
{title:"Module 2: Covered Calls and Dividends",lessons:[9,10,11,12,13,14,15]},
{title:"Module 3: Protective Puts",lessons:[16,17,18,19,20]},
{title:"Module 4: Synthetic Long Positions",lessons:[21,22,23,24,25]},
{title:"Module 5: Additional Options Structures",lessons:[26,27,28]},
{title:"Module 6: Portfolio Risk Management",lessons:[29,30,31,32,33,34]},
{title:"Course Summary",lessons:[35]}
];
